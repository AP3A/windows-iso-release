@echo off
:: Generated on 2025-11-17 12:43:30 GMT
...
:START_PROCESS
title 22631.3007_amd64_en-us_ppipro_b46a1232 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b46a1232-2383-4626-946c-2d78dee5d557&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b46a1232-2383-4626-946c-2d78dee5d557&pack=en-us&edition=ppipro&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
